...
class WebController extends Controller
{
    ...
    {
        $special = Special::take(3)->get();
        $blogs = Blog::take(3)->get();
        $coupons =  Coupon::where(['id' => 2])->withoutGlobalScopes()->first();
        ...
        $homecontent = Homecontent::where(['id' => 1])->withoutGlobalScopes()->first();
        $helps = HelpTopic::Status()->latest()->get();
        return view('web-views.home', compact('helps','special','blogs','coupons','homecontent','featured_products', 'topRated', 'bestSellProduct', 'latest_products', 'categories', 'brands', 'deal_of_the_day', 'top_sellers', 'home_categories'));
    }
    ...
    {
        $randD = BusinessSetting::where('type', 'randD')->first();
        
        return view('web-views.randD', [
            'randD' => $randD,
        ]);
    }
    ...
    {
        $contactus = BusinessSetting::where('type', 'contactus')->first();
        return view('web-views.contactus', [
