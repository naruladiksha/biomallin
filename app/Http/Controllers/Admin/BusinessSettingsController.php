...
class BusinessSettingsController extends Controller
{
    ...
    public function ranD()
    {
        ...
        return view('admin-views.business-settings.ranD', [
            'randD' => $randD,
        ]);

    }
     public function updaterand(Request $data)
    {
        $validatedData = $data->validate([
            'rnddtxt' => 'required',
        ]);
        BusinessSetting::where('type', 'randD')->update(['value' => $data->rnddtxt]);
        Toastr::success('R&D updated successfully!');
        return back();
    }
    public function contactus()
    {
         $contactus = BusinessSetting::where('type', 'contactus')->first();
        return view('admin-views.business-settings.contactus', [
            'contactus' => $contactus,
        ]);
    ...
    public function updatecontact(Request $data)
    {
        ...
        BusinessSetting::where('type', 'contactus')->update(['value' => $data->cntustxt]);
