...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'homecontent', 'as' => 'homecontent.','middleware'=>['module:product_management']], function () {
           Route::get('whyus', 'InfoController@index')->name('index');
           Route::post('storecontent', 'InfoController@storecontent')->name('storecontent');
           Route::get('edit', 'InfoController@editcontent')->name('edit');
           Route::post('update', 'InfoController@update')->name('update');
       });
       Route::group(['prefix' => 'blog', 'as' => 'blog.','middleware'=>['module:product_management']], function () {
       ...
       Route::group(['prefix' => 'special', 'as' => 'special.','middleware'=>['module:product_management']], function () {
           Route::get('index', 'SpecialController@index')->name('index');
           Route::post('store', 'SpecialController@store')->name('store');
           Route::get('list', 'SpecialController@list')->name('list');
           Route::get('edit/{id}', 'SpecialController@edit')->name('edit');
           Route::get('delete/{id}', 'SpecialController@delete')->name('delete');
           Route::post('update/{id}', 'SpecialController@update')->name('update');
       });
...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
            ...
            Route::group(['middleware'=>['module:web_&_app_settings']],function(){
                ...
                Route::get('r&d', 'BusinessSettingsController@ranD')->name('r&d');
                Route::post('update-rand', 'BusinessSettingsController@updaterand')->name('update-rand');
                Route::get('contactus', 'BusinessSettingsController@contactus')->name('contactus');
                Route::post('updatecontact', 'BusinessSettingsController@updatecontact')->name('updatecontact');
