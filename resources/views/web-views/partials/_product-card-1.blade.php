@if(isset($product))
    ...
    <div class="flash_deal_product rtl" style="border:#0000000d 1px solid;cursor: pointer; {{Session::get('direction') === "rtl" ? 'margin-right:6px;' : 'margin-left:6px;'}}"
        ...
        @endif
        <div class="arrvl" style="">
            <div class="arrvl align-items-center justify-content-center"
