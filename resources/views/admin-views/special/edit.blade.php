            ...
            <div class="card">
                ...
                <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                   <form action="{{route('admin.special.update',$special->id)}}" method="post" enctype="multipart/form-data">
                       ...
                       <div>
                         <label>Link</label>
                         <input type="text" class="form-control" name="link" value="{{$special->link}}">
                         </div>
                         <div>
                         <label>Special Content</label>
                         <input type="text" class="form-control" name="specialcont" value="{{$special->specialcontent}}">
                         </div>
                       <img width="100px" src="{{url('storage/app/public/blogs/') }}/{{$special->image}}">
