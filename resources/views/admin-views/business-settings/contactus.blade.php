    ...
    <div class="row" style="margin-top: 20px">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="{{route('admin.business-settings.updatecontact')}}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <textarea name="cntustxt" id="editor" cols="30" rows="20" class="form-control">{{$contactus->value}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12">
